# -*- coding: utf-8 -*-
"""
Created on Wed Jun 10 20:40:30 2020
...
df_model = df[['avg_salary', 'Rating', 'Size','Type of ownership', 'Industry', 'Sector', 'Revenue','num_comp',
             'hourly','employer_provided', 'job_state', 'same_state', 'age', 'python_yn', 'spark_yn', 'aws_yn',
             'azure_yn', 'sql_yn', 'ml_yn', 'job_simp', 'seniority', 'desc_len' ]]
...
'''
try1 = ['1', '2', '3', '4']
dftry = pd.DataFrame( try1, columns =['try1'])
e = dftry[dftry.try1 == max(dftry.try1)]
type(e)
